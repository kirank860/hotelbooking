...
<form onSubmit={(onSubmitHandler)} className="space-y-6">
  <Title
    ...
    font="outfit"
    title="Add Room"
    subTitle="Fill in the details carefully and accurately — include room details, pricing, and amenities to enhance the booking experience."
  />

  {/* Upload Area For Images */}
  <p className="text-gray-800 font-semibold mt-6">Images</p>

  <div className="grid grid-cols-2 sm:flex gap-4 my-2 flex-wrap">
    {Object.keys(images).map((key) => (
      <label htmlFor={`roomImage${key}`} key={key} className="cursor-pointer">
        <img
          className="max-h-40 w-40 object-cover rounded-xl border-2 border-dashed border-gray-300 hover:opacity-80 transition"
          src={
            images[key]
